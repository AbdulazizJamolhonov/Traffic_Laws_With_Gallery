...
import developer.abdulaziz.traffic_laws.databinding.FragmentImtiyozliBinding

class ImtiyozliFragment : Fragment() {
    private lateinit var binding: FragmentImtiyozliBinding
    ...
    override fun onCreateView(
        ...
        binding.apply {
            ...
            MyObject.myHome(root.context, 1)
            ...
            rvImtiyozli.adapter = myUnivrsalAdapter
