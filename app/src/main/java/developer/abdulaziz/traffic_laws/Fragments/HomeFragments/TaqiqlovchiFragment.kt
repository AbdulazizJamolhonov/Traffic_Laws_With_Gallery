...
import developer.abdulaziz.traffic_laws.databinding.FragmentTaqiqlovchiBinding

class TaqiqlovchiFragment : Fragment() {
    private lateinit var binding: FragmentTaqiqlovchiBinding
    ...
    override fun onCreateView(
        ...
        binding.apply {
            ...
            MyObject.myHome(root.context, 2)
            ...
            rvTaqiqlovchi.adapter = myUnivrsalAdapter
