...
import developer.abdulaziz.traffic_laws.databinding.FragmentOgohlantiruvchiBinding

class OgohlantiruvchiFragment : Fragment() {
    private lateinit var binding: FragmentOgohlantiruvchiBinding
    ...
    override fun onCreateView(
        ...
        binding.apply {
            MyObject.myHome(root.context, 0)
            ...
            rvOgohlantiruvchi.adapter = myUnivrsalAdapter
